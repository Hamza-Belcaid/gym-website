...
<!-- Hero Start -->
    ...
    <div class="container-fluid p-5">
        <div class="mb-5 text-center">
            ...
            <h1 class="display-3 text-uppercase mb-0" style="color: #fff;">Entrez en contact</h1>
        </div>
        <div class="row g-5 mb-5">
            <div class="col-lg-4">
                <div class="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
                    ...
                    <h5 class="text-uppercase text-primary">Visitez-nous</h5>
            ...
            <div class="col-lg-4">
                <div class="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
                    ...
                    <h5 class="text-uppercase text-primary">Envoyez-nous un email</h5>
            ...
            <div class="col-lg-4">
                <div class="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
                    ...
                    <h5 class="text-uppercase text-primary">Appelez-nous</h5>
    ...
    <div class="bg-dark p-5">
        ...
        Votre e mail a été envoyé. Merci de nous contacter. Un membre de notre équipe vous contactera bientôt.
        </div>
    </div>
</div>
